...
public class BookDetails extends JFrame implements ActionListener
{
    ...
    public BookDetails()
    {
        ...
        JLabel instruct = new JLabel("**To delete click on book name and then delete button**");
        instruct.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
        instruct.setForeground(new Color(180,0,0));
        instruct.setBounds(650,720,600,20);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try
        {
            ...
            if(ae.getSource() == b1)
            {
                ...
                String sql = "Select * from book where Name || Book_id like ?";
                PreparedStatement st = con.c.prepareStatement(sql);
            ...
            {
                conn con1 = new conn();
                String query = "Select * from book where name = '"+ search.getText() +"'";
                ...
                if(response == JOptionPane.YES_OPTION)
                {
                    ...
                    //conn con2 = new conn();
                    String sql1 = "Delete from availablebook where name = '"+ search.getText() +"'";

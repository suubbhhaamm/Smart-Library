...
public class PendingFine extends JFrame implements ActionListener
{
    ...
    public void Fines()
    {
        ...
        {
            conn con = new conn();
            String sql = "Select * from pendingFine";
    ...
    public PendingFine()
    {
        ...
        JLabel l1 = new JLabel("Pending Fines");
        ...
        JLabel instruct = new JLabel("**To remove student click on student name then on delete button**");
        instruct.setFont(new Font("Trebuchet MS", Font.PLAIN, 15));
        instruct.setForeground(new Color(180,0,0));
        instruct.setBounds(560,720,600,20);
        contentPane.add(instruct);
        
        JPanel panel = new JPanel();
        panel.setBorder(new TitledBorder(new LineBorder(new Color(0,128,128), 3, true), "Pending-Fines-Panel",
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try
        {
            ...
            {
                conn con = new conn();
                String sql = "Select * from pendingFine where STUDENT_NAME || STUDENT_ID || BOOK_NAME like ?";
                PreparedStatement st = con.c.prepareStatement(sql);
            ...
            {
                conn con1 = new conn();
                String query = "Select * from pendingFine where Student_Name = '"+ search.getText() +"'";
                ...
                if(response == JOptionPane.YES_OPTION)
                {
                    ...
                    String sql = "Delete from pendingFine where STUDENT_NAME = '"+ search.getText() +"'";
                    PreparedStatement st = con1.c.prepareStatement(sql);
                    st.executeUpdate();
                    st.close();
                
                    String sq = "Select * from pendingFine";
                    ...
                    JOptionPane.showMessageDialog(null, "Error! Please click on Student Name and then delete button to delete.");
